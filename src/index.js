document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    let perc = (quiz.currentQuestionIndex / quiz.questions.length) * 100;
    //let questionPerc = questionCount * 10 + '%'
    // let perc = (100 / quiz.questions.length) * quiz.currentQuestionIndex;
  ...
  const resetQuizBtnElement = document.getElementById("restartButton");
  resetQuizBtnElement.addEventListener("click", () => {
    endView.style.display = "none";
